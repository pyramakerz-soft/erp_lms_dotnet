...
namespace LMS_CMS_PL.Controllers.Domains.Accounting
{
    ...
    public class DebitController : ControllerBase
    {
        ...
        public DebitController(DbContextFactoryService dbContextFactory, IMapper mapper, CheckPageAccessService checkPageAccessService)
        {
        ...
        public IActionResult Edit(DebitPutDTO EditedDebit)
        {
            ...
            {
                IActionResult? accessCheck = _checkPageAccessService.CheckIfEditPageAvailable(Unit_Of_Work, "Debit", roleId, userId, DebitExists);
                if (accessCheck != null)
                {
                    return accessCheck;
                }
        ...
        public IActionResult Delete(long id)
        {
            ...
            if (userTypeClaim == "employee")
            {
                IActionResult? accessCheck = _checkPageAccessService.CheckIfDeletePageAvailable(Unit_Of_Work, "Debit", roleId, userId, debit);
                if (accessCheck != null)
                {
                    return accessCheck;
                }
