...
namespace LMS_CMS_PL.Controllers.Domains.Accounting
{
    ...
    public class GetTableDataAccordingToLinkFileController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTableDataAccordingToLinkFile(long id)
        {
            ...
            LinkFile LinkFile = Unit_Of_Work.linkFile_Repository.First_Or_Default(t => t.ID == id);
            if (LinkFile == null)
            {
