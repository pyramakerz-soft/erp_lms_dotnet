...
export const routes: Routes = [
    ...
    { 
        ...
        children: [
            ...
            { path: "Items", component: ShopItemsComponent, title: "Shop Items" , canActivate:[noNavigateWithoutLoginGuard ]},
            ...
            { path: "Sales Returns", component: InventoryMasterComponent, title: "Sales Returns", canActivate: [noNavigateWithoutLoginGuard], data: { id: 12 } },
            { path: "Sales Returns Item/:FlagId", component: InventoryDetailsComponent, title: "Sales Returns Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Sales Returns Item/Edit/:FlagId/:id", component: InventoryDetailsComponent, title: "Sales Returns Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            ...
            { path: "Opening Balances Item/:FlagId", component: InventoryDetailsComponent, title: "Opening Balances Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Opening Balances Item/Edit/:FlagId/:id", component: InventoryDetailsComponent, title: "Opening Balances Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Addition", component: InventoryMasterComponent, title: "Sales", canActivate: [noNavigateWithoutLoginGuard], data: { id: 2 } },
            { path: "Addition Item/:FlagId", component: InventoryDetailsComponent, title: "Addition Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Addition Item/Edit/:FlagId/:id", component: InventoryDetailsComponent, title: "Addition Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Addition Adjustment", component: InventoryMasterComponent, title: "Sales", canActivate: [noNavigateWithoutLoginGuard], data: { id: 3 } },
            { path: "Addition Adjustment Item/:FlagId", component: InventoryDetailsComponent, title: "Addition Adjustment Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Addition Adjustment Item/Edit/:FlagId/:id", component: InventoryDetailsComponent, title: "Addition Adjustment Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Disbursement", component: InventoryMasterComponent, title: "Sales", canActivate: [noNavigateWithoutLoginGuard], data: { id: 4 } },
            { path: "Disbursement Item/:FlagId", component: InventoryDetailsComponent, title: "Disbursement Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Disbursement Item/Edit/:FlagId/:id", component: InventoryDetailsComponent, title: "Disbursement Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Disbursement Adjustment", component: InventoryMasterComponent, title: "Sales", canActivate: [noNavigateWithoutLoginGuard], data: { id: 5 } },
            { path: "Disbursement Adjustment Item/:FlagId", component: InventoryDetailsComponent, title: "Disbursement Adjustment Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            { path: "Disbursement Adjustment Item/Edit/:FlagId/:id", component: InventoryDetailsComponent, title: "Disbursement Adjustment Item" , canActivate:[noNavigateWithoutLoginGuard ]},
            ...
            { path: "Shop Item/:id", component: ShopItemComponent, title: "Shop Item", canActivate:[noNavigateWithoutLoginGuard ] },
