...
export class FloorComponent {
  ...
  constructor(public account: AccountService, public buildingService: BuildingService, public ApiServ: ApiService, public EditDeleteServ: DeleteEditPermissionService, 
    private menuService: MenuService, public activeRoute: ActivatedRoute, public floorService: FloorService, public employeeService:EmployeeService, public router:Router){}
  ...
  getBuildingData(){
    this.buildingService.GetByID(this.buildingId, this.DomainName).subscribe(
      (data) => {
        this.building = data;
      }
    )
  ...
  getFloorData(){
    this.floorService.GetByBuildingId(this.buildingId, this.DomainName).subscribe(
      (data) => {
        this.floorData = data;
      }
    )
  ...
  deleteFloor(id:number){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.floorService.Delete(id, this.DomainName).subscribe(
          (data: any) => {
            this.floorData=[]
            this.getFloorData()
          }
