...
namespace LMS_CMS_BL.UOW
{
    public class UOW
    {
        ...
        GenericRepo<StudentHygiens> StudentHygiens_Repository;
        ...
        public GenericRepo<StudentHygiens> studentHygiens_Repository
        {
            get
            {
                if (StudentHygiens_Repository == null)
                {
                    StudentHygiens_Repository = new GenericRepo<StudentHygiens>(db);
                }
